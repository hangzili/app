                ...
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">hAdmin</strong>  <strong class="font-bold"><a href="/exit">退出登录</a></strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="/rbac/user_role_list">用户角色展示</a>
                            </li>
                    ...
                    <li>
                        <a href="mailbox.html"><i class="fa fa-envelope"></i> <span class="nav-label">商品 </span><span class="label label-warning pull-right">16</span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="/goods/add">商品添加</a>
                            </li>
                            <li><a class="J_menuItem" href="/goods/list">商品展示</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a class="J_menuItem" href="{{url('usercoupons/list')}}">用户优惠卷展示</a>
                            </li>

                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-desktop"></i> <span class="nav-label">分类</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="/cat/add">分类添加</a>
                            </li>
                            <li><a class="J_menuItem" href="/cat/list">分类展示</a>
                            </li>
                        </ul>
                    </li>
                    <li class="line dk"></li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="/brand/add">品牌添加</a>
                            </li>
                            <li><a class="J_menuItem" href="/brand/list">品牌展示</a>
                            </li>
                        </ul>
                    </li>
                    <li class="line dk"></li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-picture-o"></i> <span class="nav-label">商品类型</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="/type/type">商品类型添加</a>
                            </li>
                            <li><a class="J_menuItem" href="/type/typelist">商品类型展示</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-picture-o"></i> <span class="nav-label">商品属性</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="/attr/attr">商品属性添加</a>
                            </li>
                            <li><a class="J_menuItem" href="/attr/attrlist">商品属性展示</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="/img/img">轮播图添加</a>
                            </li>
                            <li><a class="J_menuItem" href="/img/imglist">轮播图展示</a>
                            </li>
                        </ul>
                    </li>
